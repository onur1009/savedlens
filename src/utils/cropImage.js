export const createImage = (url) =>
  new Promise((resolve, reject) => {
    ...
    image.setAttribute('crossOrigin', 'anonymous') // needed to avoid CORS issues on some inputs
    image.src = url
  })
...
export default async function getCroppedImg(
  ...
  // Set the canvas to 150x150 for our specific exact size
  croppedCanvas.width = 150
  croppedCanvas.height = 150

  // Draw the cropped image onto the new canvas at exact target size
